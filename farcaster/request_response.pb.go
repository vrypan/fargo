...
func (m *BulkMessageResponse) GetResponse() isBulkMessageResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *BulkMessageResponse) GetMessage() *Message {
	if x, ok := x.GetResponse().(*BulkMessageResponse_Message); ok {
		return x.Message
	}
	return nil
}
...
func (x *BulkMessageResponse) GetMessageError() *MessageError {
	if x, ok := x.GetResponse().(*BulkMessageResponse_MessageError); ok {
...
func (m *StreamSyncRequest) GetRequest() isStreamSyncRequest_Request {
	if m != nil {
		return m.Request
	}
	return nil
...
func (x *StreamSyncRequest) GetGetInfo() *HubInfoRequest {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetInfo); ok {
		return x.GetInfo
	}
	return nil
}
...
func (x *StreamSyncRequest) GetGetCurrentPeers() *Empty {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetCurrentPeers); ok {
...
func (x *StreamSyncRequest) GetStopSync() *Empty {
	if x, ok := x.GetRequest().(*StreamSyncRequest_StopSync); ok {
		return x.StopSync
	}
	return nil
}
...
func (x *StreamSyncRequest) GetForceSync() *SyncStatusRequest {
	if x, ok := x.GetRequest().(*StreamSyncRequest_ForceSync); ok {
		return x.ForceSync
	}
	return nil
}
...
func (x *StreamSyncRequest) GetGetSyncStatus() *SyncStatusRequest {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetSyncStatus); ok {
...
func (x *StreamSyncRequest) GetGetAllSyncIdsByPrefix() *TrieNodePrefix {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetAllSyncIdsByPrefix); ok {
...
func (x *StreamSyncRequest) GetGetAllMessagesBySyncIds() *SyncIds {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetAllMessagesBySyncIds); ok {
...
func (x *StreamSyncRequest) GetGetSyncMetadataByPrefix() *TrieNodePrefix {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetSyncMetadataByPrefix); ok {
...
func (x *StreamSyncRequest) GetGetSyncSnapshotByPrefix() *TrieNodePrefix {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetSyncSnapshotByPrefix); ok {
...
func (x *StreamSyncRequest) GetGetOnChainEvents() *OnChainEventRequest {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetOnChainEvents); ok {
...
func (x *StreamSyncRequest) GetGetOnChainSignersByFid() *FidRequest {
	if x, ok := x.GetRequest().(*StreamSyncRequest_GetOnChainSignersByFid); ok {
...
func (m *StreamSyncResponse) GetResponse() isStreamSyncResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *StreamSyncResponse) GetGetInfo() *HubInfoResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetInfo); ok {
		return x.GetInfo
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetCurrentPeers() *ContactInfoResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetCurrentPeers); ok {
		return x.GetCurrentPeers
	}
	return nil
}
...
func (x *StreamSyncResponse) GetStopSync() *SyncStatusResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_StopSync); ok {
		return x.StopSync
	}
	return nil
}
...
func (x *StreamSyncResponse) GetForceSync() *SyncStatusResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_ForceSync); ok {
		return x.ForceSync
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetSyncStatus() *SyncStatusResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetSyncStatus); ok {
		return x.GetSyncStatus
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetAllSyncIdsByPrefix() *SyncIds {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetAllSyncIdsByPrefix); ok {
		return x.GetAllSyncIdsByPrefix
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetAllMessagesBySyncIds() *MessagesResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetAllMessagesBySyncIds); ok {
		return x.GetAllMessagesBySyncIds
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetSyncMetadataByPrefix() *TrieNodeMetadataResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetSyncMetadataByPrefix); ok {
		return x.GetSyncMetadataByPrefix
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetSyncSnapshotByPrefix() *TrieNodeSnapshotResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetSyncSnapshotByPrefix); ok {
		return x.GetSyncSnapshotByPrefix
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetOnChainEvents() *OnChainEventResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetOnChainEvents); ok {
		return x.GetOnChainEvents
	}
	return nil
}
...
func (x *StreamSyncResponse) GetGetOnChainSignersByFid() *OnChainEventResponse {
	if x, ok := x.GetResponse().(*StreamSyncResponse_GetOnChainSignersByFid); ok {
		return x.GetOnChainSignersByFid
	}
	return nil
}
...
func (x *StreamSyncResponse) GetError() *StreamError {
	if x, ok := x.GetResponse().(*StreamSyncResponse_Error); ok {
		return x.Error
	}
	return nil
}
...
func (m *StreamFetchRequest) GetRequest() isStreamFetchRequest_Request {
	if m != nil {
		return m.Request
	}
	return nil
...
func (x *StreamFetchRequest) GetCastMessagesByFid() *FidTimestampRequest {
	if x, ok := x.GetRequest().(*StreamFetchRequest_CastMessagesByFid); ok {
...
func (x *StreamFetchRequest) GetReactionMessagesByFid() *FidTimestampRequest {
	if x, ok := x.GetRequest().(*StreamFetchRequest_ReactionMessagesByFid); ok {
...
func (x *StreamFetchRequest) GetVerificationMessagesByFid() *FidTimestampRequest {
	if x, ok := x.GetRequest().(*StreamFetchRequest_VerificationMessagesByFid); ok {
...
func (x *StreamFetchRequest) GetUserDataMessagesByFid() *FidTimestampRequest {
	if x, ok := x.GetRequest().(*StreamFetchRequest_UserDataMessagesByFid); ok {
...
func (x *StreamFetchRequest) GetLinkMessagesByFid() *FidTimestampRequest {
	if x, ok := x.GetRequest().(*StreamFetchRequest_LinkMessagesByFid); ok {
...
func (m *StreamFetchResponse) GetResponse() isStreamFetchResponse_Response {
	if m != nil {
		return m.Response
	}
	return nil
...
func (x *StreamFetchResponse) GetMessages() *MessagesResponse {
	if x, ok := x.GetResponse().(*StreamFetchResponse_Messages); ok {
		return x.Messages
	}
	return nil
}
...
func (x *StreamFetchResponse) GetError() *StreamError {
	if x, ok := x.GetResponse().(*StreamFetchResponse_Error); ok {
		return x.Error
	}
	return nil
}
