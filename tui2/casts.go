...
func (m *CastsModel) ViewCasts() string {
	...
	m.statusBar.SetStatus(fmt.Sprintf("window.height=%d, height=%d, actual=%d", m.WindowHeight(), height, strings.Count(s.String(), "\n")))
	return s.String()
}
